# Rubrik kualitas — melody-design

Diturunkan dari `quality-control.md` §9 (Melody, hook, and thematic
development) — bagian dari SOP lama, kini didistribusikan per modul.

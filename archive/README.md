...
| `json-composition/` | `contract.md` generated (dibaca `jazz-composing`) + doktrin baru | Doktrin lama "engine does NOT humanize this path" dibalik: LLM kini menulis niat, `pyengine` yang humanize. Lihat `docs/DOCTRINE-NIAT-BUKAN-NOT.md`. |

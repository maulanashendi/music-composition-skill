...
| 14 — Detail Low Level | in-progress | `14-review.md`, `song.abc`, `drums.json`, `output.mid` | Jalankan L2 reviewer segar, L2-blind, L2-cliche, lalu L3 telinga. |

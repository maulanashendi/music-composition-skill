# Rubrik kualitas — arrangement

Diturunkan dari `quality-control.md` §3 (Development and anti-boredom),
§4 (Form and section function), §5 (Instrumental transitions), §10 (Loop
development), §11 (Improvisation), dan §12 (Ensemble interaction and
arrangement) — bagian dari SOP lama, kini didistribusikan per modul.

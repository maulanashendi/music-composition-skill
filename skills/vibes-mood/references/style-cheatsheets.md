...
Read only the entry for the target style. Each gives typical harmony, tempo, feel, and instrumentation to keep candidates idiomatic. These are starting points, not cages — bend them when the brief asks.

## Lofi jazz

- **Tempo:** 70–90 BPM. **Feel:** loose swung or straight-16th, relaxed, slightly behind.
- **Harmony:** slow harmonic rhythm (one chord/bar or slower); 2–4 chord loops; lush extensions (maj7, m9, 13); borrowed bVI/bVII color chords.
- **Structure:** short loop developed by subtraction/addition and light reharmonization; A–B–B+–A(minimal) arc works well.
...
- **Harmony:** extended and altered chords, chromatic passing motion, gospel-tinged voicings; loop-based with tasteful reharm on repeats.
- **Structure:** groove loop with a contrasting section and a breakdown.
...
- **Harmony:** fast harmonic rhythm, dense ii-V-I chains, tritone subs, secondary dominants; 32-bar AABA or 12-bar blues.
- **Structure:** head → solos over the form → head out.

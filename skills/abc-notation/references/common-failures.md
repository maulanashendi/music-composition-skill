...
- **Symptom:** `validate_abc.py` reports 0 errors, but `../../midi-orchestration/scripts/abc_to_midi.py` writes a track with 0 notes for a voice (or the voice's later bars are missing from the MIDI).

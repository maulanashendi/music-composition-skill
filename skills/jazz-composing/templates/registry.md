...
| `noir-jazz-scene` | cinematic noir jazz / dark-jazz scene score | cinematic noir/dark jazz, muted trumpet over dark piano, extreme rubato drag, ppp-pp dynamics, scene-form arc, 35-65 BPM |
| `cool-modal-quintet` | cool modal jazz | modal jazz over a static Dorian vamp, brushed floating swing, statement-rest-development melody, 100-125 BPM; optional pianoless counterpoint arrangement |
